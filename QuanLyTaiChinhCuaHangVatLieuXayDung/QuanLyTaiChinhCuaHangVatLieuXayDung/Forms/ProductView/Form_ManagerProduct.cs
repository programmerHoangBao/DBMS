...
namespace QuanLyTaiChinhCuaHangVatLieuXayDung.Forms.ProductView
{
    public partial class Form_ManagerProduct : Form
    {
        ...
        private void LoadData()
        {
            ...
            ((DataGridViewImageColumn)dataGridViewProduct.Columns["ImageProduct"]).ImageLayout = DataGridViewImageCellLayout.Stretch;
            dataGridViewProduct.RowTemplate.Height = 80;
        }
