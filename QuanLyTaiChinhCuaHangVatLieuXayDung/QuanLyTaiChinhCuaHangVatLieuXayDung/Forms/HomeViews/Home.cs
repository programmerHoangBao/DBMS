...
namespace QuanLyTaiChinhCuaHangVatLieuXayDung.Forms.HomeViews
{
    public partial class Home : Form
    {
        ...
        private void uiSymbolButtonExpenseSlips_Click(object sender, EventArgs e)
        {
            Form_ExpenseSlipManager form_ExpenseSlipManager = new Form_ExpenseSlipManager();   
            OpenFormChild(form_ExpenseSlipManager);
        }
    }
}
