...
{
    public partial class Form_ManagerCustomer : Form
    {
        private CustomerService customerService = new CustomerService();
        private string previousAction = "";

        public Form_ManagerCustomer()
        {
            InitializeComponent();
        }
        ...
        {
            this.uiDataGridViewCustomer.DataSource = customerService.GetAllCustomerBySortMoney();
